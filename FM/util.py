...
def load_dataset():
    ...
    df_user = pd.read_csv(r'E:\Recommendation_System_practice\data\ml-100k\u.user', sep='|', names=header)
    ...
    df_item = pd.read_csv(r'E:\Recommendation_System_practice\data\ml-100k\u.item', sep='|', names=header,
                          encoding="ISO-8859-1")
    ...
    df_train = pd.read_csv(r'E:\Recommendation_System_practice\data\ml-100k\ua.base', sep='\t', names=header)
    ...
    df_test = pd.read_csv(r'E:\Recommendation_System_practice\data\ml-100k\ua.test', sep='\t', names=header)
